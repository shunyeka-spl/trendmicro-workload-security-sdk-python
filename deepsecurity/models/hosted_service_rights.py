...
from deepsecurity.models.feature_flags_rights import FeatureFlagsRights  # noqa: F401,E501
...
class HostedServiceRights(object):
    ...
    swagger_types = {
        ...
        'feature_flags_rights': 'FeatureFlagsRights',
    ...
    def __init__(self, account_rights=None, fix_rights=None, heap_rights=None, license_rate_rights=None, query_rights=None, feature_flags_rights=None, query_traceback_rights=None, server_log_rights=None, stack_trace_rights=None, network_security_rights=None):  # noqa: E501
        ...
        self._feature_flags_rights = None
        ...
        if feature_flags_rights is not None:
            self.feature_flags_rights = feature_flags_rights
    ...
    @property
    def feature_flags_rights(self):
        """Gets the feature_flags_rights of this HostedServiceRights.  # noqa: E501

        Rights related to feature flags.  # noqa: E501

        :return: The feature_flags_rights of this HostedServiceRights.  # noqa: E501
        :rtype: FeatureFlagsRights
        """
        return self._feature_flags_rights

    @feature_flags_rights.setter
    def feature_flags_rights(self, feature_flags_rights):
        """Sets the feature_flags_rights of this HostedServiceRights.

        Rights related to feature flags.  # noqa: E501

        :param feature_flags_rights: The feature_flags_rights of this HostedServiceRights.  # noqa: E501
        :type: FeatureFlagsRights
        """

        self._feature_flags_rights = feature_flags_rights
